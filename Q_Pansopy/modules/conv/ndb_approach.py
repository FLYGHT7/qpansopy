...
def run_ndb_approach(iface, routing_layer):
    ...
    try:
        ...
        for feat in selection:
            ...
            # Primary area width at start: ±1.25 NM
            primary_width_start = 1.25
            ...
            # Primary area width at end: ±(L*tan(10.3°) + 1.25) NM
            primary_width_end = L*tan(radians(10.3)) + 1.25
            ...
            # Secondary width at start: ±2.0 NM
            secondary_width_start = 2.0
            ...
            # Secondary width at end: ±(L*tan(12°) + 2.0) NM
            secondary_width_end = L*tan(radians(12.0)) + 2.0
